...
Scenario: Enter project registration in Coder, setup Rave study, enter verbatim in Rave, code verbatim in Coder, and see results in Rave
  ...
  And I navigate to "Coder" for study group "study_group" from iMedidata
  ...
  And I navigate to "Rave EDC" for study group "study_group" from iMedidata
...
Scenario: Enter project registration in Coder, setup Rave study with component and supplemental fields, enter verbatim in Rave, reject verbatim in Coder, verify component and supplemental data appears in Coder, and see results in Rave
  ...
  And in Coder I Browse and Code Term "SHARP PAIN IN NERVES" on row 1, entering value "BAYER CHILDREN'S COUGH" and selecting dictionary tree row 6 and "Create Synonym"
  And I navigate to iMedidata from "Coder"
  And I navigate to "Rave EDC" for study group "RaveCoderSP24" from iMedidata
  ...
  And I take a screenshot
  And in Rave I wait for the coded term and id to appear on Coder datapoint "SHARP PAIN IN NERVES" on Rave form "ETE2" for log line 2:
